...
class SubChildServicesDataTable extends DataTable
{
    ...
    {
        return SubChildService::query()->with('child_service_id');
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'name_ar',
                 'data'=>'name_ar',
                 'title'=>trans('SubChildService.name_ar'),
		    ],
				[
                 'name'=>'name_en',
                 'data'=>'name_en',
                 'title'=>trans('SubChildService.name_en'),
		    ],
				[
                 'name'=>'child_service_id.name_ar',
                 'data'=>'child_service_id.name_ar',
                 'title'=>trans('SubChildService.child_service_id'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
