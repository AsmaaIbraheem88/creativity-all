...
class ChildServicesDataTable extends DataTable
{
    ...
    {
        return ChildService::query()->with('service_id');
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'name_ar',
                 'data'=>'name_ar',
                 'title'=>trans('ChildService.name_ar'),
		    ],
				[
                 'name'=>'name_en',
                 'data'=>'name_en',
                 'title'=>trans('ChildService.name_en'),
		    ],
				[
                 'name'=>'service_id.name_en',
                 'data'=>'service_id.name_en',
                 'title'=>trans('ChildService.service_id'),
		    ],
				[
                 'name'=>'image',
                 'data'=>'image',
                 'title'=>trans('ChildService.image'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
