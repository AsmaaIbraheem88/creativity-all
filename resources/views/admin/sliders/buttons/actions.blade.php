		...
		<div class="actions">
				<div class="btn-group">
						...
						{{ trans('slider.actions') }}
								<i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-right">
								<li>
										<a href="{{ aurl('/sliders/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('slider.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/sliders/'.$id)}}"><i class="fa fa-eye"></i> {{trans('slider.show')}}</a>
								</li>
								<li>
										<a data-toggle="modal" data-target="#delete_record{{$id}}" href="#">
						<i class="fa fa-trash"></i> {{trans('slider.delete')}}</a>
								</li>
						</ul>
				</div>
		</div>
				...
				<div class="modal-dialog">
						<div class="modal-content">
								...
								<div class="modal-body">
										<i class="fa fa-exclamation-triangle"></i> {{trans('slider.ask_del')}} {{trans('slider.id')}} ({{$id}}) ؟
								</div>
								<div class="modal-footer">
										{!! Form::open([
										'method' => 'DELETE',
										'route' => ['sliders.destroy', $id]
										]) !!}
