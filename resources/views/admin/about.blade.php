                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('about_us_ar', about()->about_us_ar ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.about_us_ar')]) !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('about_us_en', about()->about_us_en ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.about_us_en')]) !!}
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('features_ar', about()->features_ar ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.features_ar')]) !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('features_en', about()->features_en ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.features_en')]) !!}
                            </div>
                        </div>
                        <br>
