		...
		<div class="actions">
				<div class="btn-group">
						...
						{{ trans('services.actions') }}
								<i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu pull-right">
								<li>
										<a href="{{ aurl('/services/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('services.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/services/'.$id)}}"><i class="fa fa-eye"></i> {{trans('services.show')}}</a>
								</li>
								<li>
										<a data-toggle="modal" data-target="#delete_record{{$id}}" href="#">
						<i class="fa fa-trash"></i> {{trans('services.delete')}}</a>
								</li>
						</ul>
				</div>
		</div>
				...
				<div class="modal-dialog">
						<div class="modal-content">
								...
								<div class="modal-body">
										<i class="fa fa-exclamation-triangle"></i> {{trans('services.ask_del')}} {{trans('services.id')}} ({{$id}}) ؟
								</div>
