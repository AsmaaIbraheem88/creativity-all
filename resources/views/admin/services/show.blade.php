              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('services/create')}}"
                           data-toggle="tooltip" title="{{trans('services.services')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('services.ask_del')}} {{trans('services.id')}} {{$services->id}} ؟
...
<b>{{trans('services.id')}} :</b> {{$services->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.name_ar')}} :</b>
 {!! $services->name_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.name_en')}} :</b>
 {!! $services->name_en !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.description_ar')}} :</b>
 {!! $services->description_ar !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.description_en')}} :</b>
 {!! $services->description_en !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.image')}} :</b>
 {!! $services->image !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('services.active')}} :</b>
 {!! $services->active !!}
</div>
