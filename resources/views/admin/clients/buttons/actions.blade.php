		...
		<div class="actions">
				<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
								<li>
										<a href="{{ aurl('/clients/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('client.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/clients/'.$id)}}"><i class="fa fa-eye"></i> {{trans('client.show')}}</a>
								</li>
								<li>
										<a data-toggle="modal" data-target="#delete_record{{$id}}" href="#">
						<i class="fa fa-trash"></i> {{trans('client.delete')}}</a>
								</li>
						</ul>
				</div>
		</div>
				...
				<div class="modal-dialog">
						<div class="modal-content">
								...
								<div class="modal-body">
										<i class="fa fa-exclamation-triangle"></i> {{trans('client.ask_del')}} {{trans('client.id')}} ({{$id}}) ؟
								</div>
