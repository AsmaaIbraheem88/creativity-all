            ...
            <div class="portlet-body form">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('sitename_ar',social()->whatsapp,['class'=>'form-control','placeholder'=>trans('admin.whatsapp')]) !!}
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('youtube',social()->youtube,['class'=>'form-control','placeholder'=>trans('admin.youtube')]) !!}
                        </div>
                    </div>
                    <br>
